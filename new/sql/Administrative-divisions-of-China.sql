...
-- 正在导出表  db_test.area 的数据：~3,136 rows (大约)
DELETE FROM `area`;
...
-- 正在导出表  db_test.city 的数据：~346 rows (大约)
DELETE FROM `city`;
/*!40000 ALTER TABLE `city` DISABLE KEYS */;
INSERT INTO `city` (`code`, `name`, `parent_code`) VALUES
	(110100, '市辖区', 110000),
	(110200, '县', 110000),
	(120100, '市辖区', 120000),
	(120200, '县', 120000),
...
-- 正在导出表  db_test.province 的数据：~34 rows (大约)
